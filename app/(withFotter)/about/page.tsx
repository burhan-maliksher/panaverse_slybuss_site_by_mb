...
export default function About(){
    return(
        <>
            <div className='flex flex-col space-y-10 md:mt-20 mt-4 font-serif md:text-xl text-center bg-nav_color mx-5 rounded-xl mb-4 h-auto  p-5'>  
                ...
                <div className="flex flex-col">
                    ...
                    <p className="md:text-5xl text-xl">Certified Web 3.0 and Metaverse Developer</p>
                    <p className="text-3xl mb-4">A One and Quarter Years Panaverse DAO Earn as you Learn Program</p>
                    <p>Getting Ready for the Next Generation of the Internet</p>
                    <p className="mt-4">
                    ...
                    <p className="mt-4 text-rose-700 hover:text-rose-900"><Link href={"https://www.panaverse.co"} prefetch={false} target={"_blank"}>The Panaverse Community and Syllabus</Link> </p> 
                </div>

                <div className='text-base font-inder text-left md:text-center md:text-xl'>
                    <span className='text-2xl md:text-4xl'>The</span> internet is without a doubt the most important technological development in human history. Web3, 
                ...
                <div className='text-base font-inder text-left md:text-center md:text-xl'>
                <Link href={"https://icg.citi.com/icghome/what-we-think/citigps/insights/metaverse-and-money_20220330"} prefetch={false} target={"_blank"}><span className='font-bold text-blue-800 underline hover:underline-offset-4 hover:text-cyan-500'>Citi</span></Link> is the latest Wall Street business to give a positive prognosis for Web 3.0 and the Metaverse,
                ...
                <h2 className='text-2xl  md:text-4xl font-bold font-serif text-center'>Program of Studies </h2>
        ...
        <div className="flex flex-col space-y-10 mt-6  mx-5 rounded-xl mb-4 h-auto p-5">
                
                 <div className='border border-y-4  border-x-0  rounded-xl border-blue-900'>
                    <h2  className='text-bold text-4xl mt-6 text-extrabold font-serif drop-shadow-[5px_10px_4px_rgba(0,0,0,0.5)] text-center'>
                        Outcome FOR Participants
                    </h2>
                    <div className='text-base font-inder text-left  md:text-xl'>
                    ...
                    <div className='flex flex-col text-base font-inder space-y-4 my-4 text-left md:text-center md:text-xl'>
                        <Link href={'https://content.techgig.com/hiring/top-5-metaverse-jobs-that-will-rule-the-future-of-tech-industry/articleshow/87581325.cms'} prefetch={false} target={"_blank"}>
                            <span className='font-bold text-blue-800 underline hover:underline-offset-4 hover:text-cyan-500'>
