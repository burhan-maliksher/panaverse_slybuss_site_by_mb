...
export default function Nav(){
    return(
      <nav className='sticky w-screen top-0 md:fixed md:z-10  md:left-0 md:w-screen  md:h-12 font-inder flex flex-col md:flex-row md:justify-around lg:text-xl lg:justify-start lg:pl-8 lg:space-x-20 justify-center   bg-blue-900 rounded-b-xl md:rounded-bl-none lg:rounded-br-full text-white font-medium text-xs '>
        ...
        <button className='py-2 md:hover:text-sky-400 hover:bg-blue-700 md:hover:bg-blue-900 hover:text-white  '><Link href={"/syllabus"}>Syllabus</Link></button><p className='md:text-4xl hidden md:inline-block'>|</p>
        <button className='py-2 md:hover:text-sky-400  hover:bg-blue-700 hover:text-white md:hover:bg-blue-900 '><Link href={"/about"}>About</Link></button>
